...
<div id="main">
    <div class="container" style="padding-top: 60px;">
        <div class="row">
            <div class="col-lg-12">
                ...
                <ol class="breadcrumb" style="background-color: #222222">
                    ...
                    <li class="active" style="color: white">tour_ahero</li>
                </ol>
            </div>
        </div>
        ...
        <div class="row">
            <div class="col-lg-12">
                <h3 class="page-header" style="color: #fed136; border-bottom: 1px solid #fed136;"><b style="font-size: 30px;">r</b>ooms <b style="font-size: 30px;">o</b>ffered <b style="font-size: 30px;">b</b>y <b style="font-size: 30px;">a</b>hero <b style="font-size: 30px;">n</b>jokerio</h3>
            </div>

            <div class="col-lg-12">
                <ul class="nav nav-tabs nav-justified" id="myTab">
                    <li class="active"><a href="#ahero1" data-toggle="tab"><i class="fa fa-bed"></i> <b style="font-size: 20px;">r</b>oom 1</a></li>
                    <li><a href="#ahero2" data-toggle="tab"><i class="fa fa-bed"></i> <b style="font-size: 20px;">r</b>oom 2</a></li>
                    <li><a href="#ahero3" data-toggle="tab"><i class="fa fa-bed"></i> <b style="font-size: 20px;">r</b>oom 3</a></li>
                    <li><a href="#ahero4" data-toggle="tab"><i class="fa fa-bed"></i> <b style="font-size: 20px;">r</b>oom 4</a></li>
                    <li><a href="#ahero5" data-toggle="tab"><i class="fa fa-bed"></i> <b style="font-size: 20px;">r</b>oom 5</a></li>
                    <li><a href="#ahero6" data-toggle="tab"><i class="fa fa-bed"></i> <b style="font-size: 20px;">r</b>oom 6</a></li>
                    <li><a href="#ahero7" data-toggle="tab"><i class="fa fa-bed"></i> <b style="font-size: 20px;">r</b>oom 7</a></li>
                    <li><a href="#ahero8" data-toggle="tab"><i class="fa fa-bed"></i> <b style="font-size: 20px;">r</b>oom 8</a></li>
                    <li><a href="#ahero9" data-toggle="tab"><i class="fa fa-bed"></i> <b style="font-size: 20px;">r</b>oom 9</a></li>
                    <li><a href="#ahero10" data-toggle="tab"><i class="fa fa-bed"></i> <b style="font-size: 20px;">r</b>oom 10</a></li><br>
                    <li><a href="#ahero11" data-toggle="tab"><i class="fa fa-bed"></i> <b style="font-size: 20px;">r</b>oom 11</a></li>
                    <li><a href="#ahero12" data-toggle="tab"><i class="fa fa-bed"></i> <b style="font-size: 20px;">r</b>oom 12</a></li>
                    <li><a href="#ahero13" data-toggle="tab"><i class="fa fa-bed"></i> <b style="font-size: 20px;">r</b>oom 13</a></li>
                    <li><a href="#ahero14" data-toggle="tab"><i class="fa fa-bed"></i> <b style="font-size: 20px;">r</b>oom 14</a></li>
                    <li><a href="#ahero15" data-toggle="tab"><i class="fa fa-bed"></i> <b style="font-size: 20px;">r</b>oom 15</a></li>
                    <li><a href="#ahero16" data-toggle="tab"><i class="fa fa-bed"></i> <b style="font-size: 20px;">r</b>oom 16</a></li>
                    <li><a href="#ahero17" data-toggle="tab"><i class="fa fa-bed"></i> <b style="font-size: 20px;">r</b>oom 17</a></li>
                    <li><a href="#ahero18" data-toggle="tab"><i class="fa fa-bed"></i> <b style="font-size: 20px;">r</b>oom 18</a></li>
                    <li><a href="#ahero19" data-toggle="tab"><i class="fa fa-bed"></i> <b style="font-size: 20px;">r</b>oom 19</a></li>
                    <li><a href="#ahero20" data-toggle="tab"><i class="fa fa-bed"></i> <b style="font-size: 20px;">r</b>oom 20</a></li>
                </ul>

                <div class="tab-content" id="myTabContent">
                    <div class="tab-pane active fade in" id="ahero1">
                        <div class="row">
                            <div class="col-lg-9">
                    ...
                    <div class="tab-pane fade" id="ahero2">
                        <div class="row">
                            <div class="col-lg-9">
                    ...
                    <div class="tab-pane fade" id="ahero3">
                        <div class="row">
                            <div class="col-lg-9">
                    ...
                    <div class="tab-pane fade" id="ahero4">
                        <div class="row">
                            <div class="col-lg-9">
                    ...
                    <div class="tab-pane fade" id="ahero5">
                        <div class="row">
                            <div class="col-lg-9">
                    ...
                    <div class="tab-pane fade" id="ahero6">
                        <div class="row">
                            <div class="col-lg-9">
                    ...
                    <div class="tab-pane fade" id="ahero7">
                        <div class="row">
                            <div class="col-lg-9">
                    ...
                    <div class="tab-pane fade" id="ahero8">
                        <div class="row">
                            <div class="col-lg-9">
                    ...
                    <div class="tab-pane fade" id="ahero9">
                        <div class="row">
                            <div class="col-lg-9">
                    ...
                    <div class="tab-pane fade" id="ahero10">
                        <div class="row">
                            <div class="col-lg-9">
                    ...
                    <div class="tab-pane fade" id="ahero11">
                        <div class="row">
                            <div class="col-lg-9">
                    ...
                    <div class="tab-pane fade" id="ahero12">
                        <div class="row">
                            <div class="col-lg-9">
                    ...
                    <div class="tab-pane fade" id="ahero13">
                        <div class="row">
                            <div class="col-lg-9">
                    ...
                    <div class="tab-pane fade" id="ahero14">
                        <div class="row">
                            <div class="col-lg-9">
                    ...
                    <div class="tab-pane fade" id="ahero15">
                        <div class="row">
                            <div class="col-lg-9">
                    ...
                    <div class="tab-pane fade" id="ahero16">
                        <div class="row">
                            <div class="col-lg-9">
                    ...
                    <div class="tab-pane fade" id="ahero17">
                        <div class="row">
                            <div class="col-lg-9">
                    ...
                    <div class="tab-pane fade" id="ahero18">
                        <div class="row">
                            <div class="col-lg-9">
                    ...
                    <div class="tab-pane fade" id="ahero19">
                        <div class="row">
                            <div class="col-lg-9">
                    ...
                    <div class="tab-pane fade" id="ahero20">
                        <div class="row">
                            <div class="col-lg-9">
