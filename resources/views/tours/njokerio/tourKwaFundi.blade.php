...
<div id="main">
    <div class="container" style="padding-top: 60px;">
        <div class="row">
            <div class="col-lg-12">
                <h1 class="page-header" style="color: #fff; border-bottom: 1px solid #fed136;">tour
                    <small style="color: #fed136;"><b style="font-size: 30px;">k</b>wa <b style="font-size: 30px;">f</b>undi <b style="font-size: 30px;">n</b>jokerio </small>
                </h1>

                <ol class="breadcrumb" style="background-color: #222222">
                    <li><a href="/diaspora/public/home" style="color: #fed136;">home</a></li>
                    <li class="active" style="color: white">tour_kwa fundi</li>
                </ol>
            </div>
        </div>
        ...
        <div class="row">
            <div class="col-lg-12">
                <h3 class="page-header" style="color: #fed136; border-bottom: 1px solid #fed136;"><b style="font-size: 30px;">r</b>ooms <b style="font-size: 30px;">o</b>ffered <b style="font-size: 30px;">b</b>y <b style="font-size: 30px;">k</b>wa <b style="font-size: 30px;">f</b>undi <b style="font-size: 30px;">n</b>jokerio</h3>
            </div>

            <div class="col-lg-12">
                <ul class="nav nav-tabs nav-justified" id="myTab">
                    <li class="active"><a href="#kwa_fundi1" data-toggle="tab"><i class="fa fa-bed"></i> <b style="font-size: 20px;">r</b>oom 1</a></li>
                    <li><a href="#kwa_fundi2" data-toggle="tab"><i class="fa fa-bed"></i> <b style="font-size: 20px;">r</b>oom 2</a></li>
                    <li><a href="#kwa_fundi3" data-toggle="tab"><i class="fa fa-bed"></i> <b style="font-size: 20px;">r</b>oom 3</a></li>
                    <li><a href="#kwa_fundi4" data-toggle="tab"><i class="fa fa-bed"></i> <b style="font-size: 20px;">r</b>oom 4</a></li>
                    <li><a href="#kwa_fundi5" data-toggle="tab"><i class="fa fa-bed"></i> <b style="font-size: 20px;">r</b>oom 5</a></li>
                    <li><a href="#kwa_fundi6" data-toggle="tab"><i class="fa fa-bed"></i> <b style="font-size: 20px;">r</b>oom 6</a></li>
                    <li><a href="#kwa_fundi7" data-toggle="tab"><i class="fa fa-bed"></i> <b style="font-size: 20px;">r</b>oom 7</a></li>
                    <li><a href="#kwa_fundi8" data-toggle="tab"><i class="fa fa-bed"></i> <b style="font-size: 20px;">r</b>oom 8</a></li>
                    <li><a href="#kwa_fundi9" data-toggle="tab"><i class="fa fa-bed"></i> <b style="font-size: 20px;">r</b>oom 9</a></li>
                    <li><a href="#kwa_fundi10" data-toggle="tab"><i class="fa fa-bed"></i> <b style="font-size: 20px;">r</b>oom 10</a></li><br>
                    <li><a href="#kwa_fundi11" data-toggle="tab"><i class="fa fa-bed"></i> <b style="font-size: 20px;">r</b>oom 11</a></li>
                    <li><a href="#kwa_fundi12" data-toggle="tab"><i class="fa fa-bed"></i> <b style="font-size: 20px;">r</b>oom 12</a></li>
                    <li><a href="#kwa_fundi13" data-toggle="tab"><i class="fa fa-bed"></i> <b style="font-size: 20px;">r</b>oom 13</a></li>
                    <li><a href="#kwa_fundi14" data-toggle="tab"><i class="fa fa-bed"></i> <b style="font-size: 20px;">r</b>oom 14</a></li>
                    <li><a href="#kwa_fundi15" data-toggle="tab"><i class="fa fa-bed"></i> <b style="font-size: 20px;">r</b>oom 15</a></li>
                    <li><a href="#kwa_fundi16" data-toggle="tab"><i class="fa fa-bed"></i> <b style="font-size: 20px;">r</b>oom 16</a></li>
                    <li><a href="#kwa_fundi17" data-toggle="tab"><i class="fa fa-bed"></i> <b style="font-size: 20px;">r</b>oom 17</a></li>
                    <li><a href="#kwa_fundi18" data-toggle="tab"><i class="fa fa-bed"></i> <b style="font-size: 20px;">r</b>oom 18</a></li>
                    <li><a href="#kwa_fundi19" data-toggle="tab"><i class="fa fa-bed"></i> <b style="font-size: 20px;">r</b>oom 19</a></li>
                    <li><a href="#kwa_fundi20" data-toggle="tab"><i class="fa fa-bed"></i> <b style="font-size: 20px;">r</b>oom 20</a></li>
                </ul>

                <div class="tab-content" id="myTabContent">
                    <div class="tab-pane active fade in" id="kwa_fundi1">
                        <div class="row">
                            <div class="col-lg-9">
                    ...
                    <div class="tab-pane fade" id="kwa_fundi2">
                        <div class="row">
                            <div class="col-lg-9">
                    ...
                    <div class="tab-pane fade" id="kwa_fundi3">
                        <div class="row">
                            <div class="col-lg-9">
                    ...
                    <div class="tab-pane fade" id="kwa_fundi4">
                        <div class="row">
                            <div class="col-lg-9">
                    ...
                    <div class="tab-pane fade" id="kwa_fundi5">
                        <div class="row">
                            <div class="col-lg-9">
                    ...
                    <div class="tab-pane fade" id="kwa_fundi6">
                        <div class="row">
                            <div class="col-lg-9">
                    ...
                    <div class="tab-pane fade" id="kwa_fundi7">
                        <div class="row">
                            <div class="col-lg-9">
                    ...
                    <div class="tab-pane fade" id="kwa_fundi8">
                        <div class="row">
                            <div class="col-lg-9">
                    ...
                    <div class="tab-pane fade" id="kwa_fundi9">
                        <div class="row">
                            <div class="col-lg-9">
                    ...
                    <div class="tab-pane fade" id="kwa_fundi10">
                        <div class="row">
                            <div class="col-lg-9">
                    ...
                    <div class="tab-pane fade" id="kwa_fundi11">
                        <div class="row">
                            <div class="col-lg-9">
                    ...
                    <div class="tab-pane fade" id="kwa_fundi12">
                        <div class="row">
                            <div class="col-lg-9">
                    ...
                    <div class="tab-pane fade" id="kwa_fundi13">
                        <div class="row">
                            <div class="col-lg-9">
                    ...
                    <div class="tab-pane fade" id="kwa_fundi14">
                        <div class="row">
                            <div class="col-lg-9">
                    ...
                    <div class="tab-pane fade" id="kwa_fundi15">
                        <div class="row">
                            <div class="col-lg-9">
                    ...
                    <div class="tab-pane fade" id="kwa_fundi16">
                        <div class="row">
                            <div class="col-lg-9">
                    ...
                    <div class="tab-pane fade" id="kwa_fundi17">
                        <div class="row">
                            <div class="col-lg-9">
                    ...
                    <div class="tab-pane fade" id="kwa_fundi18">
                        <div class="row">
                            <div class="col-lg-9">
                    ...
                    <div class="tab-pane fade" id="kwa_fundi19">
                        <div class="row">
                            <div class="col-lg-9">
                    ...
                    <div class="tab-pane fade" id="kwa_fundi20">
                        <div class="row">
                            <div class="col-lg-9">
