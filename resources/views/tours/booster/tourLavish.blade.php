...
<div id="main">
    <div class="container" style="padding-top: 60px;">
        <div class="row">
            <div class="col-lg-12">
                <h1 class="page-header" style="color: #fff; border-bottom: 1px solid #fed136;">tour
                    <small style="color: #fed136;"><b style="font-size: 30px;">l</b>avish <b style="font-size: 30px;">b</b>ooster </small>
                </h1>

                <ol class="breadcrumb" style="background-color: #222222">
                    <li><a href="/diaspora/public/home" style="color: #fed136;">home</a></li>
                    <li class="active" style="color: white">tour_lavish</li>
                </ol>
            </div>
        </div>
        ...
        <div class="row">
            <div class="col-lg-12">
                <h3 class="page-header" style="color: #fed136; border-bottom: 1px solid #fed136;"><b style="font-size: 30px;">r</b>ooms <b style="font-size: 30px;">o</b>ffered <b style="font-size: 30px;">b</b>y <b style="font-size: 30px;">l</b>avish <b style="font-size: 30px;">b</b>ooster</h3>
            </div>

            <div class="col-lg-12">
                <ul class="nav nav-tabs nav-justified" id="myTab">
                    <li class="active"><a href="#lavish1" data-toggle="tab"><i class="fa fa-bed"></i> <b style="font-size: 20px;">r</b>oom 1</a></li>
                    <li><a href="#lavish2" data-toggle="tab"><i class="fa fa-bed"></i> <b style="font-size: 20px;">r</b>oom 2</a></li>
                    <li><a href="#lavish3" data-toggle="tab"><i class="fa fa-bed"></i> <b style="font-size: 20px;">r</b>oom 3</a></li>
                    <li><a href="#lavish4" data-toggle="tab"><i class="fa fa-bed"></i> <b style="font-size: 20px;">r</b>oom 4</a></li>
                    <li><a href="#lavish5" data-toggle="tab"><i class="fa fa-bed"></i> <b style="font-size: 20px;">r</b>oom 5</a></li>
                    <li><a href="#lavish6" data-toggle="tab"><i class="fa fa-bed"></i> <b style="font-size: 20px;">r</b>oom 6</a></li>
                    <li><a href="#lavish7" data-toggle="tab"><i class="fa fa-bed"></i> <b style="font-size: 20px;">r</b>oom 7</a></li>
                    <li><a href="#lavish8" data-toggle="tab"><i class="fa fa-bed"></i> <b style="font-size: 20px;">r</b>oom 8</a></li>
                    <li><a href="#lavish9" data-toggle="tab"><i class="fa fa-bed"></i> <b style="font-size: 20px;">r</b>oom 9</a></li>
                    <li><a href="#lavish10" data-toggle="tab"><i class="fa fa-bed"></i> <b style="font-size: 20px;">r</b>oom 10</a></li><br>
                    <li><a href="#lavish11" data-toggle="tab"><i class="fa fa-bed"></i> <b style="font-size: 20px;">r</b>oom 11</a></li>
                    <li><a href="#lavish12" data-toggle="tab"><i class="fa fa-bed"></i> <b style="font-size: 20px;">r</b>oom 12</a></li>
                    <li><a href="#lavish13" data-toggle="tab"><i class="fa fa-bed"></i> <b style="font-size: 20px;">r</b>oom 13</a></li>
                    <li><a href="#lavish14" data-toggle="tab"><i class="fa fa-bed"></i> <b style="font-size: 20px;">r</b>oom 14</a></li>
                    <li><a href="#lavish15" data-toggle="tab"><i class="fa fa-bed"></i> <b style="font-size: 20px;">r</b>oom 15</a></li>
                    <li><a href="#lavish16" data-toggle="tab"><i class="fa fa-bed"></i> <b style="font-size: 20px;">r</b>oom 16</a></li>
                    <li><a href="#lavish17" data-toggle="tab"><i class="fa fa-bed"></i> <b style="font-size: 20px;">r</b>oom 17</a></li>
                    <li><a href="#lavish18" data-toggle="tab"><i class="fa fa-bed"></i> <b style="font-size: 20px;">r</b>oom 18</a></li>
                    <li><a href="#lavish19" data-toggle="tab"><i class="fa fa-bed"></i> <b style="font-size: 20px;">r</b>oom 19</a></li>
                    <li><a href="#lavish20" data-toggle="tab"><i class="fa fa-bed"></i> <b style="font-size: 20px;">r</b>oom 20</a></li>
                </ul>

                <div class="tab-content" id="myTabContent">
                    <div class="tab-pane active fade in" id="lavish1">
                        <div class="row">
                            <div class="col-lg-9">
                    ...
                    <div class="tab-pane fade" id="lavish2">
                        <div class="row">
                            <div class="col-lg-9">
                    ...
                    <div class="tab-pane fade" id="lavish3">
                        <div class="row">
                            <div class="col-lg-9">
                    ...
                    <div class="tab-pane fade" id="lavish4">
                        <div class="row">
                            <div class="col-lg-9">
                    ...
                    <div class="tab-pane fade" id="lavish5">
                        <div class="row">
                            <div class="col-lg-9">
                    ...
                    <div class="tab-pane fade" id="lavish6">
                        <div class="row">
                            <div class="col-lg-9">
                    ...
                    <div class="tab-pane fade" id="lavish7">
                        <div class="row">
                            <div class="col-lg-9">
                    ...
                    <div class="tab-pane fade" id="lavish8">
                        <div class="row">
                            <div class="col-lg-9">
                    ...
                    <div class="tab-pane fade" id="lavish9">
                        <div class="row">
                            <div class="col-lg-9">
                    ...
                    <div class="tab-pane fade" id="lavish10">
                        <div class="row">
                            <div class="col-lg-9">
                    ...
                    <div class="tab-pane fade" id="lavish11">
                        <div class="row">
                            <div class="col-lg-9">
                    ...
                    <div class="tab-pane fade" id="lavish12">
                        <div class="row">
                            <div class="col-lg-9">
                    ...
                    <div class="tab-pane fade" id="lavish13">
                        <div class="row">
                            <div class="col-lg-9">
                    ...
                    <div class="tab-pane fade" id="lavish14">
                        <div class="row">
                            <div class="col-lg-9">
                    ...
                    <div class="tab-pane fade" id="lavish15">
                        <div class="row">
                            <div class="col-lg-9">
                    ...
                    <div class="tab-pane fade" id="lavish16">
                        <div class="row">
                            <div class="col-lg-9">
                    ...
                    <div class="tab-pane fade" id="lavish17">
                        <div class="row">
                            <div class="col-lg-9">
                    ...
                    <div class="tab-pane fade" id="lavish18">
                        <div class="row">
                            <div class="col-lg-9">
                    ...
                    <div class="tab-pane fade" id="lavish19">
                        <div class="row">
                            <div class="col-lg-9">
                    ...
                    <div class="tab-pane fade" id="lavish20">
                        <div class="row">
                            <div class="col-lg-9">
