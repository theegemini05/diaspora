    ...
    <body>
        ...
        <div id="main">
            <div class="container" style="padding-top: 60px;">
                ...
                <div class="row">
                    <div class="col-lg-12">
                        <h3 class="page-header" style="color: #fed136; border-bottom:1px solid #fed136;"><b style="font-size: 30px;">r</b>ooms <b style="font-size: 30px;">o</b>ffered <b style="font-size: 30px;">b</b>y <b style="font-size: 30px;">b</b>oraya <b style="font-size: 30px;">b</b>ooster</h3>
                    </div>

                    <div class="col-lg-12">
                        <ul class="nav nav-tabs nav-justified" id="myTab">
                            <li class="active"><a href="#boraya1" data-toggle="tab"><i class="fa fa-bed"></i> <b style="font-size: 20px;">r</b>oom 1</a></li>
                            <li><a href="#boraya2" data-toggle="tab"><i class="fa fa-bed"></i> <b style="font-size: 20px;">r</b>oom 2</a></li>
                            <li><a href="#boraya3" data-toggle="tab"><i class="fa fa-bed"></i> <b style="font-size: 20px;">r</b>oom 3</a></li>
                            <li><a href="#boraya4" data-toggle="tab"><i class="fa fa-bed"></i> <b style="font-size: 20px;">r</b>oom 4</a></li>
                            <li><a href="#boraya5" data-toggle="tab"><i class="fa fa-bed"></i> <b style="font-size: 20px;">r</b>oom 5</a></li>
                            <li><a href="#boraya6" data-toggle="tab"><i class="fa fa-bed"></i> <b style="font-size: 20px;">r</b>oom 6</a></li>
                            <li><a href="#boraya7" data-toggle="tab"><i class="fa fa-bed"></i> <b style="font-size: 20px;">r</b>oom 7</a></li>
                            <li><a href="#boraya8" data-toggle="tab"><i class="fa fa-bed"></i> <b style="font-size: 20px;">r</b>oom 8</a></li>
                            <li><a href="#boraya9" data-toggle="tab"><i class="fa fa-bed"></i> <b style="font-size: 20px;">r</b>oom 9</a></li>
                            <li><a href="#boraya10" data-toggle="tab"><i class="fa fa-bed"></i> <b style="font-size: 20px;">r</b>oom 10</a></li><br>
                            <li><a href="#boraya11" data-toggle="tab"><i class="fa fa-bed"></i> <b style="font-size: 20px;">r</b>oom 11</a></li>
                            <li><a href="#boraya12" data-toggle="tab"><i class="fa fa-bed"></i> <b style="font-size: 20px;">r</b>oom 12</a></li>
                            <li><a href="#boraya13" data-toggle="tab"><i class="fa fa-bed"></i> <b style="font-size: 20px;">r</b>oom 13</a></li>
                            <li><a href="#boraya14" data-toggle="tab"><i class="fa fa-bed"></i> <b style="font-size: 20px;">r</b>oom 14</a></li>
                            <li><a href="#boraya15" data-toggle="tab"><i class="fa fa-bed"></i> <b style="font-size: 20px;">r</b>oom 15</a></li>
                            <li><a href="#boraya16" data-toggle="tab"><i class="fa fa-bed"></i> <b style="font-size: 20px;">r</b>oom 16</a></li>
                            <li><a href="#boraya17" data-toggle="tab"><i class="fa fa-bed"></i> <b style="font-size: 20px;">r</b>oom 17</a></li>
                            <li><a href="#boraya18" data-toggle="tab"><i class="fa fa-bed"></i> <b style="font-size: 20px;">r</b>oom 18</a></li>
                            <li><a href="#boraya19" data-toggle="tab"><i class="fa fa-bed"></i> <b style="font-size: 20px;">r</b>oom 19</a></li>
                            <li><a href="#boraya20" data-toggle="tab"><i class="fa fa-bed"></i> <b style="font-size: 20px;">r</b>oom 20</a></li>
                        </ul>

                        <div class="tab-content" id="myTabContent">
                            <div class="tab-pane active fade in" id="boraya1">
                                <div class="row">
                                    <div class="col-lg-9">
                            ...
                            <div class="tab-pane fade" id="boraya2">
                                <div class="row">
                                    <div class="col-lg-9">
                            ...
                            <div class="tab-pane fade" id="boraya3">
                                <div class="row">
                                    <div class="col-lg-9">
                            ...
                            <div class="tab-pane fade" id="boraya4">
                                <div class="row">
                                    <div class="col-lg-9">
                            ...
                            <div class="tab-pane fade" id="boraya5">
                                <div class="row">
                                    <div class="col-lg-9">
                            ...
                            <div class="tab-pane fade" id="boraya6">
                                <div class="row">
                                    <div class="col-lg-9">
                            ...
                            <div class="tab-pane fade" id="boraya7">
                                <div class="row">
                                    <div class="col-lg-9">
                            ...
                            <div class="tab-pane fade" id="boraya8">
                                <div class="row">
                                    <div class="col-lg-9">
                            ...
                            <div class="tab-pane fade" id="boraya9">
                                <div class="row">
                                    <div class="col-lg-9">
                            ...
                            <div class="tab-pane fade" id="boraya10">
                                <div class="row">
                                    <div class="col-lg-9">
                            ...
                            <div class="tab-pane fade" id="boraya11">
                                <div class="row">
                                    <div class="col-lg-9">
                            ...
                            <div class="tab-pane fade" id="boraya12">
                                <div class="row">
                                    <div class="col-lg-9">
                            ...
                            <div class="tab-pane fade" id="boraya13">
                                <div class="row">
                                    <div class="col-lg-9">
                            ...
                            <div class="tab-pane fade" id="boraya14">
                                <div class="row">
                                    <div class="col-lg-9">
                            ...
                            <div class="tab-pane fade" id="boraya15">
                                <div class="row">
                                    <div class="col-lg-9">
                            ...
                            <div class="tab-pane fade" id="boraya16">
                                <div class="row">
                                    <div class="col-lg-9">
                            ...
                            <div class="tab-pane fade" id="boraya17">
                                <div class="row">
                                    <div class="col-lg-9">
                            ...
                            <div class="tab-pane fade" id="boraya18">
                                <div class="row">
                                    <div class="col-lg-9">
                            ...
                            <div class="tab-pane fade" id="boraya19">
                                <div class="row">
                                    <div class="col-lg-9">
                            ...
                            <div class="tab-pane fade" id="boraya20">
                                <div class="row">
                                    <div class="col-lg-9">
