...
<div id="main">
    <div class="container" style="padding-top: 60px;">
        <div class="row">
            <div class="col-lg-12">
                ...
                <ol class="breadcrumb" style="background-color: #222222">
                    ...
                    <li class="active" style="color: white">tour_lumiarj</li>
                </ol>
            </div>
        </div>
        ...
        <div class="row">
            <div class="col-lg-12">
                <h3 class="page-header" style="color: #fed136; border-bottom: 1px solid #fed136;"><b style="font-size: 30px;">r</b>ooms <b style="font-size: 30px;">o</b>ffered <b style="font-size: 30px;">b</b>y <b style="font-size: 30px;">l</b>umiarj <b style="font-size: 30px;">c</b>arwash</h3>
            </div>

            <div class="col-lg-12">
                <ul class="nav nav-tabs nav-justified" id="myTab">
                    <li class="active"><a href="#lumiarj1" data-toggle="tab"><i class="fa fa-bed"></i> <b style="font-size: 20px;">r</b>oom 1</a></li>
                    <li><a href="#lumiarj2" data-toggle="tab"><i class="fa fa-bed"></i> <b style="font-size: 20px;">r</b>oom 2</a></li>
                    <li><a href="#lumiarj3" data-toggle="tab"><i class="fa fa-bed"></i> <b style="font-size: 20px;">r</b>oom 3</a></li>
                    <li><a href="#lumiarj4" data-toggle="tab"><i class="fa fa-bed"></i> <b style="font-size: 20px;">r</b>oom 4</a></li>
                    <li><a href="#lumiarj5" data-toggle="tab"><i class="fa fa-bed"></i> <b style="font-size: 20px;">r</b>oom 5</a></li>
                    <li><a href="#lumiarj6" data-toggle="tab"><i class="fa fa-bed"></i> <b style="font-size: 20px;">r</b>oom 6</a></li>
                    <li><a href="#lumiarj7" data-toggle="tab"><i class="fa fa-bed"></i> <b style="font-size: 20px;">r</b>oom 7</a></li>
                    <li><a href="#lumiarj8" data-toggle="tab"><i class="fa fa-bed"></i> <b style="font-size: 20px;">r</b>oom 8</a></li>
                    <li><a href="#lumiarj9" data-toggle="tab"><i class="fa fa-bed"></i> <b style="font-size: 20px;">r</b>oom 9</a></li>
                    <li><a href="#lumiarj10" data-toggle="tab"><i class="fa fa-bed"></i> <b style="font-size: 20px;">r</b>oom 10</a></li><br>
                    <li><a href="#lumiarj11" data-toggle="tab"><i class="fa fa-bed"></i> <b style="font-size: 20px;">r</b>oom 11</a></li>
                    <li><a href="#lumiarj12" data-toggle="tab"><i class="fa fa-bed"></i> <b style="font-size: 20px;">r</b>oom 12</a></li>
                    <li><a href="#lumiarj13" data-toggle="tab"><i class="fa fa-bed"></i> <b style="font-size: 20px;">r</b>oom 13</a></li>
                    <li><a href="#lumiarj14" data-toggle="tab"><i class="fa fa-bed"></i> <b style="font-size: 20px;">r</b>oom 14</a></li>
                    <li><a href="#lumiarj15" data-toggle="tab"><i class="fa fa-bed"></i> <b style="font-size: 20px;">r</b>oom 15</a></li>
                    <li><a href="#lumiarj16" data-toggle="tab"><i class="fa fa-bed"></i> <b style="font-size: 20px;">r</b>oom 16</a></li>
                    <li><a href="#lumiarj17" data-toggle="tab"><i class="fa fa-bed"></i> <b style="font-size: 20px;">r</b>oom 17</a></li>
                    <li><a href="#lumiarj18" data-toggle="tab"><i class="fa fa-bed"></i> <b style="font-size: 20px;">r</b>oom 18</a></li>
                    <li><a href="#lumiarj19" data-toggle="tab"><i class="fa fa-bed"></i> <b style="font-size: 20px;">r</b>oom 19</a></li>
                    <li><a href="#lumiarj20" data-toggle="tab"><i class="fa fa-bed"></i> <b style="font-size: 20px;">r</b>oom 20</a></li>
                </ul>

                <div class="tab-content" id="myTabContent">
                    <div class="tab-pane active fade in" id="lumiarj1">
                        <div class="row">
                            <div class="col-lg-9">
                    ...
                    <div class="tab-pane fade" id="lumiarj2">
                        <div class="row">
                            <div class="col-lg-9">
                    ...
                    <div class="tab-pane fade" id="lumiarj3">
                        <div class="row">
                            <div class="col-lg-9">
                    ...
                    <div class="tab-pane fade" id="lumiarj4">
                        <div class="row">
                            <div class="col-lg-9">
                    ...
                    <div class="tab-pane fade" id="lumiarj5">
                        <div class="row">
                            <div class="col-lg-9">
                    ...
                    <div class="tab-pane fade" id="lumiarj6">
                        <div class="row">
                            <div class="col-lg-9">
                    ...
                    <div class="tab-pane fade" id="lumiarj7">
                        <div class="row">
                            <div class="col-lg-9">
                    ...
                    <div class="tab-pane fade" id="lumiarj8">
                        <div class="row">
                            <div class="col-lg-9">
                    ...
                    <div class="tab-pane fade" id="lumiarj9">
                        <div class="row">
                            <div class="col-lg-9">
                    ...
                    <div class="tab-pane fade" id="lumiarj10">
                        <div class="row">
                            <div class="col-lg-9">
                    ...
                    <div class="tab-pane fade" id="lumiarj11">
                        <div class="row">
                            <div class="col-lg-9">
                    ...
                    <div class="tab-pane fade" id="lumiarj12">
                        <div class="row">
                            <div class="col-lg-9">
                    ...
                    <div class="tab-pane fade" id="lumiarj13">
                        <div class="row">
                            <div class="col-lg-9">
                    ...
                    <div class="tab-pane fade" id="lumiarj14">
                        <div class="row">
                            <div class="col-lg-9">
                    ...
                    <div class="tab-pane fade" id="lumiarj15">
                        <div class="row">
                            <div class="col-lg-9">
                    ...
                    <div class="tab-pane fade" id="lumiarj16">
                        <div class="row">
                            <div class="col-lg-9">
                    ...
                    <div class="tab-pane fade" id="lumiarj17">
                        <div class="row">
                            <div class="col-lg-9">
                    ...
                    <div class="tab-pane fade" id="lumiarj18">
                        <div class="row">
                            <div class="col-lg-9">
                    ...
                    <div class="tab-pane fade" id="lumiarj19">
                        <div class="row">
                            <div class="col-lg-9">
                    ...
                    <div class="tab-pane fade" id="lumiarj20">
                        <div class="row">
                            <div class="col-lg-9">
