...
<div id="main">
    <div class="container" style="padding-top: 60px;">
        <div class="row">
            <div class="col-lg-12">
                <h1 class="page-header" style="color: #fff; border-bottom: 1px solid #fed136;">tour
                    <small style="color: #fed136;"><b style="font-size: 30px;">g</b>uests <b style="font-size: 30px;">c</b>arwash </small>
                </h1>

                <ol class="breadcrumb" style="background-color: #222222">
                    <li><a href="/diaspora/public/home" style="color: #fed136;">home</a></li>
                    <li class="active" style="color: white">tour_guests</li>
                </ol>
            </div>
        </div>
        ...
        <div class="row">
            <div class="col-lg-12">
                <h3 class="page-header" style="color: #fed136; border-bottom: 1px solid #fed136;"><b style="font-size: 30px;">r</b>ooms <b style="font-size: 30px;">o</b>ffered <b style="font-size: 30px;">b</b>y <b style="font-size: 30px;">g</b>uests <b style="font-size: 30px;">c</b>arwash</h3>
            </div>

            <div class="col-lg-12">
                <ul class="nav nav-tabs nav-justified" id="myTab">
                    <li class="active"><a href="#guests1" data-toggle="tab"><i class="fa fa-bed"></i> <b style="font-size: 20px;">r</b>oom 1</a></li>
                    <li><a href="#guests2" data-toggle="tab"><i class="fa fa-bed"></i> <b style="font-size: 20px;">r</b>oom 2</a></li>
                    <li><a href="#guests3" data-toggle="tab"><i class="fa fa-bed"></i> <b style="font-size: 20px;">r</b>oom 3</a></li>
                    <li><a href="#guests4" data-toggle="tab"><i class="fa fa-bed"></i> <b style="font-size: 20px;">r</b>oom 4</a></li>
                    <li><a href="#guests5" data-toggle="tab"><i class="fa fa-bed"></i> <b style="font-size: 20px;">r</b>oom 5</a></li>
                    <li><a href="#guests6" data-toggle="tab"><i class="fa fa-bed"></i> <b style="font-size: 20px;">r</b>oom 6</a></li>
                    <li><a href="#guests7" data-toggle="tab"><i class="fa fa-bed"></i> <b style="font-size: 20px;">r</b>oom 7</a></li>
                    <li><a href="#guests8" data-toggle="tab"><i class="fa fa-bed"></i> <b style="font-size: 20px;">r</b>oom 8</a></li>
                    <li><a href="#guests9" data-toggle="tab"><i class="fa fa-bed"></i> <b style="font-size: 20px;">r</b>oom 9</a></li>
                    <li><a href="#guests10" data-toggle="tab"><i class="fa fa-bed"></i> <b style="font-size: 20px;">r</b>oom 10</a></li><br>
                    <li><a href="#guests11" data-toggle="tab"><i class="fa fa-bed"></i> <b style="font-size: 20px;">r</b>oom 11</a></li>
                    <li><a href="#guests12" data-toggle="tab"><i class="fa fa-bed"></i> <b style="font-size: 20px;">r</b>oom 12</a></li>
                    <li><a href="#guests13" data-toggle="tab"><i class="fa fa-bed"></i> <b style="font-size: 20px;">r</b>oom 13</a></li>
                    <li><a href="#guests14" data-toggle="tab"><i class="fa fa-bed"></i> <b style="font-size: 20px;">r</b>oom 14</a></li>
                    <li><a href="#guests15" data-toggle="tab"><i class="fa fa-bed"></i> <b style="font-size: 20px;">r</b>oom 15</a></li>
                    <li><a href="#guests16" data-toggle="tab"><i class="fa fa-bed"></i> <b style="font-size: 20px;">r</b>oom 16</a></li>
                    <li><a href="#guests17" data-toggle="tab"><i class="fa fa-bed"></i> <b style="font-size: 20px;">r</b>oom 17</a></li>
                    <li><a href="#guests18" data-toggle="tab"><i class="fa fa-bed"></i> <b style="font-size: 20px;">r</b>oom 18</a></li>
                    <li><a href="#guests19" data-toggle="tab"><i class="fa fa-bed"></i> <b style="font-size: 20px;">r</b>oom 19</a></li>
                    <li><a href="#guests20" data-toggle="tab"><i class="fa fa-bed"></i> <b style="font-size: 20px;">r</b>oom 20</a></li>
                </ul>

                <div class="tab-content" id="myTabContent">
                    <div class="tab-pane active fade in" id="guests1">
                        <div class="row">
                            <div class="col-lg-9">
                    ...
                    <div class="tab-pane fade" id="guests2">
                        <div class="row">
                            <div class="col-lg-9">
                    ...
                    <div class="tab-pane fade" id="guests3">
                        <div class="row">
                            <div class="col-lg-9">
                    ...
                    <div class="tab-pane fade" id="guests4">
                        <div class="row">
                            <div class="col-lg-9">
                    ...
                    <div class="tab-pane fade" id="guests5">
                        <div class="row">
                            <div class="col-lg-9">
                    ...
                    <div class="tab-pane fade" id="guests6">
                        <div class="row">
                            <div class="col-lg-9">
                    ...
                    <div class="tab-pane fade" id="guests7">
                        <div class="row">
                            <div class="col-lg-9">
                    ...
                    <div class="tab-pane fade" id="guests8">
                        <div class="row">
                            <div class="col-lg-9">
                    ...
                    <div class="tab-pane fade" id="guests9">
                        <div class="row">
                            <div class="col-lg-9">
                    ...
                    <div class="tab-pane fade" id="guests10">
                        <div class="row">
                            <div class="col-lg-9">
                    ...
                    <div class="tab-pane fade" id="guests11">
                        <div class="row">
                            <div class="col-lg-9">
                    ...
                    <div class="tab-pane fade" id="guests12">
                        <div class="row">
                            <div class="col-lg-9">
                    ...
                    <div class="tab-pane fade" id="guests13">
                        <div class="row">
                            <div class="col-lg-9">
                    ...
                    <div class="tab-pane fade" id="guests14">
                        <div class="row">
                            <div class="col-lg-9">
                    ...
                    <div class="tab-pane fade" id="guests15">
                        <div class="row">
                            <div class="col-lg-9">
                    ...
                    <div class="tab-pane fade" id="guests16">
                        <div class="row">
                            <div class="col-lg-9">
                    ...
                    <div class="tab-pane fade" id="guests17">
                        <div class="row">
                            <div class="col-lg-9">
                    ...
                    <div class="tab-pane fade" id="guests18">
                        <div class="row">
                            <div class="col-lg-9">
                    ...
                    <div class="tab-pane fade" id="guests19">
                        <div class="row">
                            <div class="col-lg-9">
                    ...
                    <div class="tab-pane fade" id="guests20">
                        <div class="row">
                            <div class="col-lg-9">
