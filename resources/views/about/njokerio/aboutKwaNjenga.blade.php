...
<div class="container" style="padding-top: 60px;">
    <div class="row">
        <div class="col-lg-12">
            ...
            <ol class="breadcrumb" style="background-color: #222222">
                ...
                <li class="active" style="color: white">about_kwa_njenga</li>
            </ol>
        </div>
    </div>
    ...
    <div class="row">
        ...
        <div class="col-md-4" style="color: #fff">
            <h2 style="border-bottom: 1px solid #fed136; font-size: larger; color: #fed136;">about <b style="font-size: 30px;">k</b>wa <b style="font-size: 30px">n'</b>jenga <b style="font-size: 30px">n</b>jokerio </h2>
            <p>address</p>
    ...
    <div class="row" style="color: #fed136;">
        <div class="col-lg-12">
            <h2 class="page-header" style="border-bottom: 1px solid #fed136;">our team</h2>
        </div>
