    ...
    <div class="container" style="padding-top: 60px;">
        <div class="row">
            <div class="col-lg-12">
                ...
                <ol class="breadcrumb" style="background-color: #222222">
                    ...
                    <li class="active" style="color: white">about_mwisho_wa_lami</li>
                </ol>
            </div>
        </div>
        ...
        <div class="row">
            ...
            <div class="col-md-4" style="color: #fff;">
                <h2 style="border-bottom: 1px solid #fed136; font-size: larger; color: #fed136;"><b style="font-size: 30px;">a</b>bout <b style="font-size: 30px;">m</b>wisho <b style="font-size: 30px">w</b>a <b style="font-size: 30px">l</b>ami <b style="font-size: 30px">n</b>jokerio </h2>
                <p>address</p>
