    ...
    <div class="container" style="padding-top: 60px;">
        <div class="row">
            <div class="col-lg-12">
                ...
                <ol class="breadcrumb" style="background-color: #222222">
                    ...
                    <li class="active" style="color: white">about_kwa_fundi</li>
                </ol>
            </div>
        </div>
        ...
        <div class="row">
            ...
            <div class="col-md-4" style="color: #fff;">
                <h2 style="border-bottom: 1px solid #fed136; font-size: larger; color: #fed136;"><b style="font-size: 30px;">a</b>bout <b style="font-size: 30px;">k</b>wa <b style="font-size: 30px">f</b>undi <b style="font-size: 30px">n</b>jokerio </h2>
                <p>address</p>
            ...
            <div class="col-md-4 text-center">
                <div class="thumbnail" style="border: 1px solid #222222">
                    ...
                    <div class="caption">
                        ...
                        <p style="text-align:right;><i class="><i class="fa fa-envelope-o"></i>
