    ...
    <div class="container" style="padding-top: 60px;">
        <div class="row">
            <div class="col-lg-12">
                ...
                <ol class="breadcrumb" style="background-color: #222222">
                    ...
                    <li class="active" style="color: white">contact_kwa_naff</li>
                </ol>
            </div>
        </div>
        ...
        <div class="row">
            ...
            <div class="col-md-4" style="color: #fed136;">
                <h3 style="border-bottom: 1px solid #fed136;"><b style="font-size: 30px">c</b>ontact <b style="font-size: 30px;">k</b>wa <b style="font-size: 30px;">n</b>aff</h3>
                <p>Egerton 867-40200</p>
                <p><i class="fa fa-phone"></i>
                    <abbr title="Phone">P</abbr>: (+254) 700000000
                </p>
                <p><i class="fa fa-envelope-o"></i>
                    <abbr title="Email Address">E</abbr>: <a style="color: #fed136;" href="mailto:kwanaff@gmail.com">kwanaff@gmail.com</a>
                </p>
